...
double priority_calc(Hand* hand){
    ...
    int max=-1,max_index=0,no_of_j=0;
...
int main(){
    ...
    dict = create_dict();
    add_item_label(dict,"J",&(int){0});
    add_item_label(dict,"2",&(int){1});
    add_item_label(dict,"3",&(int){2});
    add_item_label(dict,"4",&(int){3});
    add_item_label(dict,"5",&(int){4});
    add_item_label(dict,"6",&(int){5});
    add_item_label(dict,"7",&(int){6});
    add_item_label(dict,"8",&(int){7});
    add_item_label(dict,"9",&(int){8});
    add_item_label(dict,"T",&(int){9});
    ...
    qsort(game,1000,sizeof(Hand*),compare);  // In place sort based on priority_calc()
